...
var B = (e)=>{
    ...
    let { src: e, customDomain: t = st } = param;
    let r;
    try {
        r = new URL("".concat(e));
    } catch (e) {
...
function Pe(e, t) {
    t.on(E.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o, param)=>{
        let { tracks: s } = param;
        s.forEach((a)=>{
            var l, u;
            let i = (l = a.subtitleTrack) != null ? l : a.closedCaptions, c = t.subtitleTracks.findIndex((param)=>{
                let { lang: y, name: m, type: f } = param;
    ...
    let r = ()=>{
        ...
        if (t.subtitleTrack < 0 || (o == null ? void 0 : o.id) !== a) {
            let i = t.subtitleTracks.findIndex((param)=>{
                let { lang: c, name: d, type: l, default: u } = param;
    ...
    e.textTracks.addEventListener("change", r), t.on(E.Events.CUES_PARSED, (o, param)=>{
...
async function ke(e, t) {
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : _e;
...
var Dt = (e)=>{
    ...
    let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : V({
        src: e
    });
    var c, d, l, u;
...
}, It = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.generateUUID, qr = function() {
    let { playbackId: e, customDomain: t = S, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: c, playbackToken: d, tokens: { playback: l = d } = {}, extraSourceParams: u = {} } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!e) return;
    let [y, m = ""] = B(e), f = new URL("https://stream.".concat(t, "/").concat(y, ".m3u8").concat(m));
...
var Vt = (e, t)=>{
    ...
    let { playbackId: e, tokens: { drm: t } = {}, customDomain: r = S } = param;
    let o = z(e);
    ...
    var c;
    let { envKey: n, disableTracking: o, muxDataSDK: s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], muxDataSDKOptions: a = {} } = e, i = Ze(e);
    if (!o && (n || i)) {
    ...
    if (v(t, "durationchange", d), t && n) {
        ...
        if (typeof o == "string") {
            if (o.endsWith(".mp4") && o.includes(s)) {
                let g = je(o), M = new URL("https://stream.".concat(s, "/").concat(g, "/metadata.json"));
                pe(M.toString(), t);
            }
            let m = ()=>{
        ...
        if (f.muxCode === b.NETWORK_NOT_READY) {
            ...
            if (D < 6) {
                let p = D === 0 ? 5e3 : 6e4, _ = new T("Retrying in ".concat(p / 1e3, " seconds..."), f.code, f.fatal);
...
//# sourceMappingURL=node_modules_a7c1f7b2._.js.map